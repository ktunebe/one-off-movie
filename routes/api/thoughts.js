...
router.post('/', async (req, res) => {
	try {
		...
		// Adds thought to user thought array
		...
		res.json(
			`Thought '${thought.thoughtText}' has been added by ${user.username} (Thought ID: ${thought._id}, User ID: ${user._id})`
		)
	} catch (err) {
		console.log(err)
...
router.delete('/:_id', async (req, res) => {
	...
	try {
		...
		// Removes deleted thought from user thoughts array
...
router.post('/:thoughtId/reactions', async (req, res) => {
	...
	try {
		...
		// Adds reaction to thought array
...
router.delete('/:thoughtId/reactions/:reactionId', async (req, res) => {
	...
	try {
		// Removes deleted reaction from thought array
		await Thought.findByIdAndUpdate(
			thoughtId,
